...
public class BankMain {
	...
	public static void main(String[] args) throws BusinessException {
		...
		do {
			...
			try {
				...
				log.error("Please enter a number in the given range\n");
			}
			switch (ch) {
			case 1:
				displayLogin();
	...
	public static void displayLogin() throws BusinessException {
		...
		do {
			...
			try {
				...
				log.error("Please enter a number in range 1-3\n");
			}
			switch (ch) {
			case 1:
				userLogin();
	...
	public static void withdraw(User user) {
		...
		try {
			...
			log.error("Enter a number in the given range \n");
		}
	...
	public static void transfer(User user) {
		...
		depo = Double.parseDouble(sc.nextLine());
		log.info("Enter the recipient's account number:");
		transferAccount.setAccountId(Integer.parseInt(sc.nextLine()));
